...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    lettersGuessed = []
    mistakesMade = 0
    guesses = 8 - mistakesMade
    gameOn = True
    splitSecretWord = list(secretWord)
    print("Welcome to the game, Hangman!")
    print("I am thinking of a word that is {} letters long.".format(secretWordLength))
    print("-----------")
    while(gameOn):
        ...
        if guess in lettersGuessed:
            ...
            print("-----------")
        elif guess in splitSecretWord and guess not in lettersGuessed:
